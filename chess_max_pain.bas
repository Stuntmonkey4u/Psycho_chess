...
37029 IF MOVE$ = "KING FROM E1 TO D1" AND TURN = 1 AND E1$ = "K" AND D1$ = " " THEN E1$ = " ": D1$ = "K": TURN = 2: GOTO 3220: END IF
37030 IF MOVE$ = "KING FROM E1 TO D2" AND TURN = 1 AND E1$ = "K" AND D2$ = " " THEN E1$ = " ": D2$ = "K": TURN = 2: GOTO 3220: END IF
37031 IF MOVE$ = "KING FROM E1 TO E2" AND TURN = 1 AND E1$ = "K" AND E2$ = " " THEN E1$ = " ": E2$ = "K": TURN = 2: GOTO 3220: END IF
37032 IF MOVE$ = "KING FROM E1 TO F2" AND TURN = 1 AND E1$ = "K" AND F2$ = " " THEN E1$ = " ": F2$ = "K": TURN = 2: GOTO 3220: END IF
37033 IF MOVE$ = "KING FROM E1 TO F1" AND TURN = 1 AND E1$ = "K" AND F1$ = " " THEN E1$ = " ": F1$ = "K": TURN = 2: GOTO 3220: END IF
37034 REM
...
37007 REM --- MOVES FROM B1 ---
IF MOVE$ = "KING FROM E1 TO D1" AND TURN = 1 AND E1$ = "K" AND D1$ = " " THEN E1$ = " ": D1$ = "K": E1_MOVED = 1: TURN = 2: GOTO 3220: END IF
IF MOVE$ = "KING FROM E1 TO D2" AND TURN = 1 AND E1$ = "K" AND D2$ = " " THEN E1$ = " ": D2$ = "K": E1_MOVED = 1: TURN = 2: GOTO 3220: END IF
IF MOVE$ = "KING FROM E1 TO E2" AND TURN = 1 AND E1$ = "K" AND E2$ = " " THEN E1$ = " ": E2$ = "K": E1_MOVED = 1: TURN = 2: GOTO 3220: END IF
IF MOVE$ = "KING FROM E1 TO F2" AND TURN = 1 AND E1$ = "K" AND F2$ = " " THEN E1$ = " ": F2$ = "K": E1_MOVED = 1: TURN = 2: GOTO 3220: END IF
IF MOVE$ = "KING FROM E1 TO F1" AND TURN = 1 AND E1$ = "K" AND F1$ = " " THEN E1$ = " ": F1$ = "K": E1_MOVED = 1: TURN = 2: GOTO 3220: END IF
... and so on for all 64 squares
38000 REM (END OF WHITE KING MOVES)
38001 REM
39000 REM *** BLACK KING MOVES ***
39001 REM ----------------------
39002 REM
...
52001 REM
52002 REM --- FROM A1 ---
52003 IF MOVE$ = "ROOK FROM A1 TO A8" AND TURN = 1 AND A1$ = "R" AND A2$ = " " AND A3$ = " " AND A4$ = " " AND A5$ = " " AND A6$ = " " AND A7$ = " " AND (A8$="p" OR A8$="r" OR A8$="n" OR A8$="b" OR A8$="q") THEN A1$ = " ": A8$ = "R": TURN = 2: GOTO 3220: END IF
